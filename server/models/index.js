...
db.principals= require('./principal')(sequelize, DataTypes);
...
db.documents.belongsTo(db.files, {foreignKey:'fileId'})
db.documents.belongsTo(db.languages, {foreignKey:'languageId'})
db.document_results.belongsTo(db.documents,{foreignKey:'documentId'} )
db.document_results.belongsTo(db.algorithms,{foreignKey:'algorithmId'})
db.stages_of_progress_of_files.belongsTo(db.files, {foreignKey:'fileId'})
db.stages_of_progress_of_files.belongsTo(db.statuses, {foreignKey:'statusId'})
db.profession_units.belongsTo(db.companies, {foreignKey:'companyId'})
