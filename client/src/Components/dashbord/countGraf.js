...
function CountGraf() {
    ...
    const { data: dy, loading: ly, error: et, refetch: ry } = useAxiosGet("dashboard/filesByYear", 2);
    const { data: dm, loading: lm, error: em, refetch: rm } = useAxiosGet("dashboard/filesByMonth", 2);
